...
// To port M5Stack, refer to https://macsbug.wordpress.com/2018/03/07/pacman-with-m5stack/
...
if(M5.BtnA.isPressed() && M5.BtnC.isPressed()){ ClearKeys(); but_UP=true; }
if(M5.BtnB.isPressed() && M5.BtnC.isPressed()){ ClearKeys(); but_DOWN=true; }
if(M5.BtnA.isPressed()){ ClearKeys(); but_LEFT=true; }
if(M5.BtnB.isPressed()){ ClearKeys(); but_RIGHT=true; }
